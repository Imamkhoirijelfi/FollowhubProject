...
@section("content")
    ...
    <div class="page-wrapper">
        ...
        <section class="cta-two cta-two__about-page" style="background-image: url(assets/images/backgrounds/banner-halaman-programs.png);">
            <div class="container text-center">
                <h3>Our best programs</h3>
            </div><!-- /.container -->
        </section><!-- /.cta-two -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center">
                        <div class="faq-two__image">
                            <img src="assets/images/resources/program.svg" alt="">
                        </div><!-- /.faq-two__image -->
                    </div><!-- /.col-lg-6 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="faq-one__block">
                            <div class="block-title-two text-left">
                                <h3>Apa itu Followhub Connect Enterprise?</h3>
                    ...
                    <div class="col-lg-4">
                        <div class="faq-one__form-wrap">
                            <form action="#" class="contact-one__form">
                                <h3>Silahkan hubungi kami untuk diskusi</h3>
                                <div class="row">
                                    <div class="col-lg-12">
